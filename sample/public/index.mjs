...
//howler.jsによる音楽定義
//ド
const sound_C5 = new Howl({
  src: '/sound/C5.wav'
});
//レ
const sound_D5 = new Howl({
  src: '/sound/D5.wav'
});
//ミ
const sound_E5 = new Howl({
  src: '/sound/E5.wav'
});
//ファ
const sound_F5 = new Howl({
  src: '/sound/F5.wav'
});
//ソ
const sound_G5 = new Howl({
  src: '/sound/G5.wav'
});
//ラ
const sound_A5 = new Howl({
  src: '/sound/A5.wav'
});
//シ
const sound_B5 = new Howl({
  src: '/sound/B5.wav'
});
//ド＋
const sound_C6 = new Howl({
  src: '/sound/C6.wav'
});
